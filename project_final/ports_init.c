...
void portE_init(void)
{
    ...
    GPIO_PORTE_CR_R |=0xFC;   // control reg
    GPIO_PORTE_AFSEL_R &= ~0xF0;  //0x03;  // input &output
    GPIO_PORTE_PCTL_R &= ~0xF0;   //0x03;  //no alternative function
    GPIO_PORTE_AMSEL_R &= ~0xF0;    //0x03; // no analog function
    GPIO_PORTE_DIR_R |=0xFC; //output
    GPIO_PORTE_DEN_R |=0xFC;   //Digital
    GPIO_PORTE_PUR_R &=0x03;  //PULL UP RESISTOR
